  ...
  return (
    <div className="min-h-screen bg-[#fff8f6] text-[#201a17] flex flex-col justify-center items-center p-4 sm:p-6 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl border border-[#d7c2b9] p-8 sm:p-10 shadow-xl shadow-[#964407]/5 relative z-10 space-y-6">
        ...
        {verificationSent && (
          <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs space-y-2 animate-fadeIn">
            ...
            <p className="text-emerald-700 leading-relaxed">
              We have sent an official activation link to <strong className="font-semibold">{email}</strong>. Redirecting you to your portfolio...
            </p>
            {resendStatus && <p className="text-[11px] font-medium text-emerald-600">{resendStatus}</p>}
          </div>
        )}
        ...
        <form onSubmit={handleEmailSignUp} className="space-y-4">
          ...
          >
            {isLoading ? (
              ...
              <span className="flex items-center gap-2">
                <span>Continue & Start Free Trial</span>
        ...
        {/* Resend Link CTA (if verification sent) */}
        {verificationSent && (
          <div className="text-center pt-1">
            ...
            >
              Didn&apos;t receive the email? Click to resend verification link
            </button>
          </div>
        )}
