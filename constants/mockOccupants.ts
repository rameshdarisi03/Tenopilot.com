...
export function generateMockOccupants(count = 25): Occupant[] {
  const curatedCases: Occupant[] = [
    // 🌟 Genuine Onboarded Tenant 1 (Skipped KYC)
    {
      id: "og-tenant-1786315000001",
      name: "Rohan Sharma",
      avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=RohanSharma",
      ...
      workplace: "Infosys Tech",
      address: "Koramangala, Bengaluru",
      aadhaarNumber: "Skipped",
      emergencyContact: { name: "Rajesh Sharma", phone: "+91 98111 00000", relation: "Father" },
      securityDeposit: 25000,
      depositStatus: "PENDING",
      arrearsBalance: 0,
      paymentHistory: [],
    },
    // 🌟 Genuine Onboarded Tenant 2 (Skipped KYC)
    {
      id: "og-tenant-1786315000002",
      name: "Priya Ananth",
      avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=PriyaAnanth",
      phone: "+91 98222 33445",
      email: "priya.ananth@example.com",
      stayType: "Tenant",
      lifecycleStatus: "Active",
      paymentStatus: "Due",
      daysDiff: 30,
      ...
      kycVerified: false,
      hasPdfAgreement: true,
      workplace: "Wipro Digital",
      address: "Indiranagar, Bengaluru",
      aadhaarNumber: "Skipped",
      emergencyContact: { name: "Ananth Kumar", phone: "+91 98222 00000", relation: "Father" },
      securityDeposit: 25000,
      depositStatus: "PENDING",
      arrearsBalance: 0,
      paymentHistory: [],
    },
    // 🌟 Genuine Onboarded Tenant 3 (Skipped KYC)
    {
      id: "og-tenant-1786315000003",
      name: "Karthik Raja",
      avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=KarthikRaja",
      ...
      aadhaarNumber: "Skipped",
      emergencyContact: { name: "Raja Sundaram", phone: "+91 98333 00000", relation: "Father" },
      securityDeposit: 25000,
      depositStatus: "PENDING",
      arrearsBalance: 0,
      paymentHistory: [],
    },
    // 🌟 Genuine Onboarded Tenant 4 (Skipped KYC)
    {
      id: "og-tenant-1786315000004",
      name: "Divya Reddy",
      avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=DivyaReddy",
      ...
      kycVerified: false,
      hasPdfAgreement: true,
      workplace: "Accenture Dev",
      address: "HSR Layout, Bengaluru",
      aadhaarNumber: "Skipped",
      emergencyContact: { name: "Pratap Reddy", phone: "+91 98444 00000", relation: "Father" },
      securityDeposit: 25000,
      depositStatus: "PENDING",
      arrearsBalance: 0,
      paymentHistory: [],
    },
    // 🌟 Genuine Onboarded Tenant 5 (Skipped KYC)
    {
      id: "og-tenant-1786315000005",
      name: "Amitabh Joshi",
      avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=AmitabhJoshi",
      ...
      kycVerified: false,
      hasPdfAgreement: true,
      workplace: "Dell Technologies",
      address: "Domlur, Bengaluru",
      aadhaarNumber: "Skipped",
      emergencyContact: { name: "Suresh Joshi", phone: "+91 98555 00000", relation: "Father" },
      securityDeposit: 25000,
      depositStatus: "PENDING",
      arrearsBalance: 0,
      paymentHistory: [],
    },
    // Case 0A: tera01 (Tenant - Photo Uploaded, Aadhaar Skipped)
    {
      id: "tera01",
      name: "tera01",
      avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150",
      phone: "+91 99887 76655",
      email: "tera01@example.com",
      stayType: "Tenant",
      lifecycleStatus: "Active",
      paymentStatus: "Due",
      daysDiff: 0,
      ...
      address: "HSR Layout, Bengaluru",
      aadhaarNumber: "Skipped",
      emergencyContact: { name: "Guardian", phone: "+91 99887 00000", relation: "Family" },
      securityDeposit: 5750,
      depositStatus: "PENDING",
      arrearsBalance: 0,
      paymentHistory: [],
    },
    // Case 0B: tera02 (Guest - Full KYC Verified with Photo + Aadhaar)
    {
      id: "tera02",
      name: "tera02",
      avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150",
      phone: "+91 98765 43210",
      email: "tera02@guest.com",
      stayType: "Guest",
      lifecycleStatus: "Active",
      paymentStatus: "Due",
      daysDiff: 7,
      ...
      bedCode: "BED A",
      joiningDate: "06 Aug 2026",
      vacatingDate: "13 Aug 2026",
      kycVerified: true,
      hasPdfAgreement: false,
      workplace: "Corporate Event",
      address: "Indiranagar, Bengaluru",
      aadhaarNumber: "9822-4411-9988",
      emergencyContact: { name: "Parent", phone: "+91 98765 00000", relation: "Parent" },
